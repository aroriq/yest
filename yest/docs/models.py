...
class ContractModel(models.Model):
    ...
    contractdate = models.DateField(verbose_name='契約開始日', default=None, blank=True, null=True, )
    ...
    hosyo = models.PositiveSmallIntegerField(verbose_name='月額保証料', default=None, blank=True, null=True, )
    kasai = models.PositiveSmallIntegerField(verbose_name='火災保険料', default=None, blank=True, null=True, )
    chukai = models.PositiveSmallIntegerField(verbose_name='仲介手数料', default=None, blank=True, null=True, )
    etc3 = models.PositiveSmallIntegerField(verbose_name='清掃料', default=None, blank=True, null=True, )
    hosyoitaku = models.PositiveSmallIntegerField(verbose_name='初回保証委託料', default=None, blank=True, null=True, )
    ff = models.PositiveSmallIntegerField(verbose_name='FF分解整備料', default=None, blank=True, null=True, )
    cyrinder = models.PositiveSmallIntegerField(verbose_name='シリンダー交換料', default=None, blank=True, null=True, )
    etc1 = models.PositiveSmallIntegerField(verbose_name='その他1(備考欄参照)', default=None, blank=True, null=True, )
    etc2 = models.PositiveSmallIntegerField(verbose_name='その他2(備考欄参照)', default=None, blank=True, null=True, )
