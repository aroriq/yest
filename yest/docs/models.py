...
class ContractModel(models.Model):
    ...
    contractdate = models.DateField(verbose_name='契約開始日', default='', blank=True, null=True, )
    occupdate = models.DateField(verbose_name='入居日', default='', blank=True, null=True, )
    postdate = models.DateField(verbose_name='登録日時', auto_now_add=True, blank=True, null=True)
    update = models.DateField(verbose_name='更新日時', auto_now=True, null=True)
    month1 = models.PositiveSmallIntegerField(verbose_name='当月', default='1', blank=True, null=True, )
    month2 = models.PositiveSmallIntegerField(verbose_name='翌月', default='1', blank=True, null=True, )
    ...
    hosyo = models.PositiveSmallIntegerField(verbose_name='月額保証料', default='0', blank=True, null=True, )
    kasai = models.PositiveSmallIntegerField(verbose_name='火災保険料', default='0', blank=True, null=True, )
    chukai = models.PositiveSmallIntegerField(verbose_name='仲介手数料', default='0', blank=True, null=True, )
    clean = models.PositiveSmallIntegerField(verbose_name='清掃料', default='0', blank=True, null=True, )
    hosyoitaku = models.PositiveSmallIntegerField(verbose_name='初回保証委託料', default='0', blank=True, null=True, )
    ff = models.PositiveSmallIntegerField(verbose_name='FF分解整備料', default='0', blank=True, null=True, )
    cyrinder = models.PositiveSmallIntegerField(verbose_name='シリンダー交換料', default='0', blank=True, null=True, )
    etc1 = models.PositiveSmallIntegerField(verbose_name='その他1(備考欄参照)', default='0', blank=True, null=True, )
    etc2 = models.PositiveSmallIntegerField(verbose_name='その他2(備考欄参照)', default='0', blank=True, null=True, )
    etc3 = models.PositiveSmallIntegerField(verbose_name='その他3(備考欄参照)', default='0', blank=True, null=True, )
    total = models.PositiveSmallIntegerField(verbose_name='合計金額(税込)', default='0', blank=True, null=True, )
    deposit = models.PositiveSmallIntegerField(verbose_name='合計金額(税込)', default='0', blank=True, null=True, )
    zankin = models.PositiveSmallIntegerField(verbose_name='差引残金', default='0', blank=True, null=True, )
    billdate = models.PositiveSmallIntegerField(verbose_name='差引残金入金日', default='0', blank=True, null=True, )
    # 必要書類
    jumin1 = models.BooleanField(verbose_name='入居者全員住民票(本籍省略)', default=True, blank=True, null=True, )
    jumin2 = models.BooleanField(verbose_name='入居者全員住民票(本籍記載)', default=False, blank=True, null=True, )
    inkan = models.BooleanField(verbose_name='印鑑証明書', default=False, blank=True, null=True, )
    mibun = models.BooleanField(verbose_name='身分証明書写し', default=False, blank=True, null=True, )
    hoken = models.BooleanField(verbose_name='社会保険証写し', default=False, blank=True, null=True, )
    syotoku = models.BooleanField(verbose_name='所得証明書', default=False, blank=True, null=True, )
    syaken = models.BooleanField(verbose_name='車検証写し', default=False, blank=True, null=True, )
    gakusei = models.BooleanField(verbose_name='学生証写し', default=False, blank=True, null=True, )
    zaiseki = models.BooleanField(verbose_name='在籍証明書', default=False, blank=True, null=True, )
    naitei = models.BooleanField(verbose_name='内定通知書', default=False, blank=True, null=True, )
    gokaku = models.BooleanField(verbose_name='合格通知書', default=False, blank=True, null=True, )
